...
SuitAttributes = {'f': {'name': TTLocalizer.SuitFlunky, # cog name
 ...
 'dot': {'name': 'Darth Tomato',
		...
		'attacks':
                ...
                ('PowerTrip',
					...
					(95,95,95,95,95,95,95,95,95,95),
					(15,15,15,15,15,15,15,15,15,15)))},
 'kb': {'name': 'King Berry.boss',
        'singularname': 'a King Berry.boss',
		'pluralname': 'King Berries.boss',
		'level': 44,
		'hp':(30000,),
		'def':(80,),
		'freq':(0,),
 ...
 'bbs': {'name': 'Bomb Star',
		...
		'attacks':
		        (('Bomb',
				    (101,114,127,139,151,163,174,187,197,205),
					(95,95,95,95,95,95,95,95,95,95),
					(35,35,35,35,35,35,35,35,35,35)),
                ('BombCake',
				    (80,87,94,101,109,118,129,141,152,164),
					(95,95,95,95,95,95,95,95,95,95),
					(35,35,35,35,35,35,35,35,35,35)),
                ('PoisonSpray',
				    (67,89,114,147,174,211,234,250,275,300),
					(40,45,50,55,60,65,70,75,80,85),
					(15,15,15,15,15,15,15,15,15,15)),
                ('SwirlBath',
				    (89,94,100,109,119,130,142,155,169,183),
					(95,95,95,95,95,95,95,95,95,95),
					(15,15,15,15,15,15,15,15,15,15)))},
 'fd': {'name': 'Fashion Designer.boss',
        'singularname': 'a Fashion Designer.boss',
		'pluralname': 'Fashion Designers.boss',
		'level': 29,
		'hp':(15000,),
		'def':(50,),
		'freq':(0,),
 ...
 'ad': {'name': 'Alfred',
		...
		'attacks':
                ...
                ('NotThrowPiano',
					...
					(100,100,100,100,100,100,100,100,100,100),
					(20,20,20,20,20,20,20,20,20,20)))},
 'dm': {'name': 'Doctor Money.boss',
        'singularname': 'a Doctor Money.boss',
		'pluralname': 'Doctor Money.boss',
		'level': 34,
		'hp':(20000,),
		'def':(75,),
		'freq':(0,),
 ...
 'sb': {'name': 'Robber Safe',
		...
		'attacks':
                ...
                ('Crunch',
					...
					(40,45,50,55,60,65,70,75,80,85),
					(25,25,25,25,25,25,25,25,25,25)))},
 'cm': {'name': 'Court Manager.boss',
        'singularname': 'a Court Manager.boss',
		'pluralname': 'Court Managers.boss',
		'level': 39,
		'hp':(25000,),
		'def':(60,),
		'freq':(0,),
