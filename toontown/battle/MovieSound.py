...
soundFiles = ('AA_sound_bikehorn.ogg', 'AA_sound_whistle.ogg', 'AA_sound_bugle.ogg', 'AA_sound_aoogah.ogg', 'AA_sound_elephant.ogg', 'AA_sound_fogning.ogg', 'AA_sound_Opera_Singer.ogg')
    ...
    for sound in sounds:
        ...
        for target in targets:
            ...
            if revived:
                ...
                deathTracks.append(MovieUtil.createVirtualDeathTrack(suit, toon, battle))
            elif died:
