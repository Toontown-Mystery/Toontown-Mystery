...
class PlayByPlayText(OnscreenText.OnscreenText):
    ...
    def getShowInterval(self, text, duration):
        return Sequence(Func(self.hide), LerpScaleInterval(self, duration=0.5, scale=(1, 1, 1)), LerpColorScaleInterval(self, duration=0, colorScale=(0, 0, 1, 0)), LerpColorScaleInterval(self, duration=0.5, colorScale=(0, 0, 1, 1)), Func(self.setText, text), Func(self.show), Wait(1.5), LerpColorScaleInterval(self, duration=1.0, colorScale=(0, 0, 1, 0)), Func(self.hide))
