...
SuitAttackTaunts = {'Audit': ["Let me find your answer right here.",
 ...
 'BuzzWord': ['What do the sound of these things make?.',
              ...
              "According to all known laws of aviation, there is no way a bee should be able to fly - its wings are too small to carry its fat, little body off the ground. The bee, of course, flies anyway because they don't care what humans think is impossible."],
