...
AvPropDamage = ((((8, 9), (Levels[0][0], Levels[0][1])),
 ...
 (((40, 50), (Levels[1][0], Levels[1][1])),
  ((70, 85), (Levels[1][1], Levels[1][2])),
  ((100, 170), (Levels[1][2], Levels[1][3])),
  ((200, 260), (Levels[1][3], Levels[1][4])),
  ((280, 380), (Levels[1][4], Levels[1][5])),
  ((500, 800), (Levels[1][5], Levels[1][6])),
 ...
 (((3, 7), (Levels[5][0], Levels[5][1])),
  ((9, 14), (Levels[5][1], Levels[5][2])),
  ((16, 20), (Levels[5][2], Levels[5][3])),
  ((24, 30), (Levels[5][3], Levels[5][4])),
  ((45, 60), (Levels[5][4], Levels[5][5])),
  ((100, 150), (Levels[5][5], Levels[5][6])),
  ((180, 180), (Levels[5][6], MaxSkill))),
