...
class DistributedCashbotBoss(DistributedBossCog.DistributedBossCog, FSM.FSM):
                ...
                Sequence(
                    ...
                    Parallel(
                        ...
                        Parallel(
                            ...
                            Wait(2.5),
                            Func(self.clearChat),
                            Func(self.setChatAbsolute, "And the drama between Master Cool Cat.", CFSpeech),
                            Wait(2.5),
                            Func(self.clearChat),
                            Func(self.setChatAbsolute, "Well, new Cogs, have anything to say?", CFSpeech),
                            Wait(2.5),
                            Func(self.clearChat),
                            ...
                            Parallel(Func(self.suit.setChatAbsolute, "We've been tricked! They're Toons!", CFSpeech), Func(self.suit.play, 'finger-wag')),
                            Wait(3),
                            Func(self.suit.clearChat),
                            ...
                            Parallel(Func(self.suit.loop, 'walk'), self.suit.hprInterval(2, VBase3(180, 0, 0)), Func(self.suit.setChatAbsolute, "Where do you think you're going?", CFSpeech)),
    ...
    def makePrepareBattleTwoMovie(self, delayDeletes):
        ...
        bossTrack.append(track)
        rToon = self.resistanceToon
        rToon.setPosHpr(93.935, -341.065, 0, 270, 0, 0)
        ...
        track = Sequence(
            ...
            Func(self.suit.setChatAbsolute, 'Well, Queen...', CFSpeech),
            Wait(2),
            Func(self.suit.clearChat),
            ...
            Wait(3),
            Func(rToon.clearChat),
            Func(rToon.setChatAbsolute, "Not only me, but Master Cool Cat as well...", CFSpeech|CFTimeout),
            Wait(2),
            Func(rToon.clearChat),
            ...
            Sequence(
                ...
                Parallel(
                    Sequence(
                        ...
                        Wait(3),
                        Func(self.clearChat),
                        Func(self.setChatAbsolute, 'Toons like you have no accomplishment.', CFSpeech),
                        Wait(3),
                        Func(self.clearChat),
