...
class DistributedCashbotBoss(DistributedBossCog.DistributedBossCog, FSM.FSM):
                ...
                Sequence(
                    ...
                    Parallel(
                        ...
                        Parallel(
                            ...
                            Parallel(Func(self.suit.setChatAbsolute, "We've been tricked! They're Toons!", CFSpeech), Func(self.suit.play, 'glower')),
                            Wait(3),
                            Func(self.suit.clearChat),
                            ...
                            Sequence(
                                ...
                                Parallel(
                                    ...
                                    Func(self.suit.setChatAbsolute, "What do you think you're going?", CFSpeech),
                                    Wait(2),
                                    Func(self.suit.clearChat),
    ...
    def makePrepareBattleTwoMovie(self, delayDeletes):
        ...
        track = Sequence(
            ...
            Func(self.suit.clearChat),
            base.camera.posHprInterval(1.5, Point3(100, -332.612, 5), Point3(136.3, 0, 0), blendType='easeInOut'),
            Func(rToon.setChatAbsolute, "So you don't care about what I have o go through...? </3", CFSpeech),
            Wait(3),
            Func(rToon.clearChat),
            ...
            Sequence(
                ...
                Parallel(
                    Sequence(
                        ...
                        Func(self.setChatAbsolute, 'No! Amanda, come back!', CFSpeech),
                        Wait(3),
                        Func(self.clearChat),
