    ...
    def showHpText(self, number, bonus = 0, scale = 1, attackTrack = -1, immuneRevert=0):
        if self.HpTextEnabled and not self.ghostMode:
            if number != 0:
                ...
                seq = Sequence(self.hpText.posInterval(0.1, Point3(0, 0, self.height + 1.5), blendType='easeOut'), 
                Wait(0.85), 
                self.hpText.colorScaleInterval(0.1, Vec4(r, g, b, 0), blendType='easeOut'),
                Wait(1),
