...
class BossCog(Avatar.Avatar):
    ...
    def getAnim(self, anim):
        ...
        if anim == None:
            ...
            ival = Sequence(Track((0, ival), (0, Sequence(SoundInterval(self.spinSfx, node=self))), (1.3, Parallel(SoundInterval(self.rainGearsSfx, node=self), ParticleInterval(pe8, self.corner4Attack, worldRelative=0, duration=1.5, cleanup=True), ParticleInterval(pe7, self.corner3Attack, worldRelative=0, duration=1.5, cleanup=True), ParticleInterval(pe6, self.corner2Attack, worldRelative=0, duration=1.5, cleanup=True), ParticleInterval(pe5, self.corner1Attack, worldRelative=0, duration=1.5, cleanup=True), ParticleInterval(pe4, self.leftAttack, worldRelative=0, duration=1.5, cleanup=True), ParticleInterval(pe3, self.rightAttack, worldRelative=0, duration=1.5, cleanup=True), ParticleInterval(pe2, self.backAttack, worldRelative=0, duration=1.5, cleanup=True), ParticleInterval(pe, self.frontAttack, worldRelative=0, duration=1.5, cleanup=True), duration=0)), (1.9, Func(self.bubbleJ.unstash)), (1.9, Func(self.bubbleI.unstash)), (1.9, Func(self.bubbleH.unstash)), (1.9, Func(self.bubbleG.unstash)), (1.9, Func(self.bubbleF.unstash)), (1.9, Func(self.bubbleFL.unstash)), (1.9, Func(self.bubbleFR.unstash)), (1.9, Func(self.bubbleB.unstash))), Func(self.bubbleJ.stash), Func(self.bubbleI.stash), Func(self.bubbleH.stash), Func(self.bubbleG.stash), Func(self.bubbleF.stash), Func(self.bubbleFL.stash), Func(self.bubbleFR.stash), Func(self.bubbleB.stash))
            self.forward = 1
            self.happy = 0
            self.raised = 1
