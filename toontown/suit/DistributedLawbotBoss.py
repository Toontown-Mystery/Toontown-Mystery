...
class DistributedLawbotBoss(DistributedBossCog.DistributedBossCog, FSM.FSM):
    ...
    def __init__(self, cr):
        ...
        self.witnessToon1 = None
        self.witnessToon2 = None
    ...
    def announceGenerate(self):
        ...
        self.__makeWitnessToon1()
        self.__makeWitnessToon2()
        self.__loadMopaths()
    ...
    def __makeWitnessToon1(self):
        npc = NPCToons.createLocalNPC(997)
        npc.setName('Makoto')
        npc.setPickable(0)
        npc.setPlayerType(NametagGroup.CCNonPlayer)
        npc.animFSM.request('neutral')
        self.witnessToon1 = npc
        self.witnessToon1.setPosHpr(-2.798, -105, 0, 0, 0, 0)
        self.witnessToon1.doId = 0

    def __makeWitnessToon2(self):
        npc = NPCToons.createLocalNPC(2310)
        npc.setName('Junko Enoshima')
        npc.setPickable(0)
        npc.setPlayerType(NametagGroup.CCNonPlayer)
        npc.animFSM.request('neutral')
        self.witnessToon2 = npc
        self.witnessToon2.setPosHpr(-6, -105, 0, 0, 0, 0)
        self.witnessToon2.doId = 0

    def makeIntroductionMovie(self, delayDeletes):
        self.notify.debug('----- makeIntroductionMovie')
        alertSfx = base.loadSfx('phase_11/audio/sfx/AA_sound_aoogah.ogg')
        coloreffectSfx = base.loadSfx('phase_11/audio/sfx/LB_sparks_1.ogg')
        sendeffectSfx = base.loadSfx('phase_11/audio/sfx/goofy_scream.ogg')
        toondetectedeffectSfx = base.loadSfx('phase_5/audio/sfx/tt_s_ara_cfg_propellerBreaks.ogg')
        self.__showWitnessToon()
        self.witnessToon1.show()
        self.witnessToon2.show()
        for toonId in self.involvedToons:
            toon = self.cr.doId2do.get(toonId)
            if toon:
        ...
        track = Parallel()
        dialogTrack = Track(
            (0, Sequence(Func(self.loop, 'Ff_speech'), Func(base.camera.reparentTo, render), camera.posHprInterval(3, Point3(-2.4, -110.6, 19.5), Point3(0, 0, 0), blendType='easeInOut'))),
            (3, Func(self.setChatAbsolute, "Hey there, Cogs.", CFSpeech)),
            (6, Func(self.clearChat)),
            (6, Sequence(Func(base.camera.reparentTo, render), camera.posHprInterval(3, Point3(-2.4, -100.6, 19.5), Point3(0, 0, 0), blendType='easeInOut'))),
            (9, Func(self.setChatAbsolute, "Today, we are going to have a debate.", CFSpeech)),
            (12, Func(self.clearChat)),
            (12, Sequence(Func(base.camera.reparentTo, render), camera.posHprInterval(2, Point3(56, 80, 15.5), Point3(0, 0, 0), blendType='easeInOut'))),
            (14, Func(self.witnessToon.setChatAbsolute, "Hey there, my fellow Toons!", CFSpeech)),
            (18, Func(self.witnessToon.clearChat)),
            (18, Sequence(Func(base.camera.reparentTo, render), camera.posHprInterval(2, Point3(53, 80, 15.5), Point3(-30, 0, 0), blendType='easeInOut'))),
            (20, Func(self.witnessToon.setChatAbsolute, "Today we're going to learn about the brand new crime scene that happened.", CFSpeech)),
            (24, Func(self.witnessToon.clearChat)),
            (24, Sequence(Func(base.camera.reparentTo, render), camera.posHprInterval(0, Point3(-2.4, -100.6, 19.5), Point3(0, 0, 0), blendType='easeInOut'))),
            (24, Func(self.setChatAbsolute, "?", CFSpeech)),
            (26, Func(self.clearChat)),
            (26, Func(self.setChatAbsolute, "I thought we were having a debate.", CFSpeech)),
            (30, Func(self.clearChat)),
            (30, Sequence(Func(base.camera.reparentTo, render), camera.posHprInterval(0, Point3(53, 80, 15.5), Point3(-30, 0, 0), blendType='easeInOut'))),
            (30, Func(self.witnessToon.setChatAbsolute, "No. We're gonna learn about the crime scene.", CFSpeech)),
            (34, Func(self.witnessToon.clearChat)),
            (34, Sequence(Func(base.camera.reparentTo, render), camera.posHprInterval(0, Point3(-19.8, -102, 19.5), Point3(-40, 0, 0), blendType='easeInOut'))),
            (34, Func(self.setChatAbsolute, "Your idea is stupid, I say we're going to debate.", CFSpeech)),
            (38, Func(self.clearChat)),
            (38, Sequence(Func(base.camera.reparentTo, render), camera.posHprInterval(0, Point3(56, 75, 15.5), Point3(0, 0, 0), blendType='easeInOut'))),
            (38, Sequence(Func(base.camera.reparentTo, render), camera.posHprInterval(2, Point3(56, 82, 15.5), Point3(0, 0, 0), blendType='easeInOut'))),
            (40, Func(self.witnessToon.setChatAbsolute, "Well too bad, Monokuma gave us permission to investigate this crime scene.", CFSpeech)),
            (44, Func(self.witnessToon.clearChat)),
            (44, Sequence(Func(self.witnessToon1.reparentTo, render), Func(self.witnessToon1.addActive))),
            (44, Sequence(Func(self.witnessToon2.reparentTo, render), Func(self.witnessToon2.addActive))),
            (44, Sequence(Func(base.camera.reparentTo, render), camera.posHprInterval(2, Point3(-2.4, -95, 3), Point3(180, 0, 0), blendType='easeInOut'))),
            (46, Func(self.witnessToon1.angryEyes)),
            (46, Func(self.witnessToon2.angryEyes)),
            (46, Func(self.witnessToon1.blinkEyes)),
            (46, Func(self.witnessToon2.blinkEyes)),
            (46, Parallel(Func(self.witnessToon1.setChatAbsolute, "Not so fast!", CFSpeech), SoundInterval(alertSfx))),
            (50, Func(self.witnessToon1.clearChat)),
            (50, Sequence(Func(base.camera.reparentTo, render), camera.posHprInterval(1, Point3(-6, -95, 3), Point3(180, 0, 0), blendType='easeInOut'))),
            (51, Sequence(Func(base.camera.reparentTo, render), camera.posHprInterval(0.5, Point3(-4, -97, 3), Point3(150, 0, 0), blendType='easeInOut'))),
            (51.5, Parallel(Func(self.witnessToon2.setChatAbsolute, "What on earth do you think you're doing, Aoi!?", CFSpeech))),
            (55, Func(self.witnessToon2.clearChat)),
            (55, Func(self.witnessToon.surpriseEyes)),
            (55, Sequence(Func(base.camera.reparentTo, render), camera.posHprInterval(0, Point3(56, 82, 15.5), Point3(0, 0, 0), blendType='easeInOut'))),
            (55, Func(self.witnessToon.setChatAbsolute, "Makoto and Junko?", CFSpeech)),
            (59, Func(self.witnessToon.clearChat)),
            (59, Sequence(Func(base.camera.reparentTo, render), camera.posHprInterval(1, Point3(59, 80, 15.5), Point3(30, 0, 0), blendType='easeInOut'))),
            (60, Func(self.witnessToon.sadEyes)),
            (60, Func(self.witnessToon.blinkEyes)),
            (60, Func(self.witnessToon.showSmileMuzzle)),
            (60, Func(self.witnessToon.setChatAbsolute, "Heh.. What brings you here...?", CFSpeech)),
            (64, Func(self.witnessToon.clearChat)),
            (64, Sequence(Func(base.camera.reparentTo, render), camera.posHprInterval(0, Point3(-4, -97, 3), Point3(150, 0, 0), blendType='easeInOut'))),
            (64, Parallel(Func(self.witnessToon2.setChatAbsolute, "Don't you 'heh' me!", CFSpeech))),
            (68, Func(self.witnessToon2.clearChat)),
            (68, Sequence(Func(base.camera.reparentTo, render), camera.posHprInterval(1, Point3(-2, -96.5, 3), Point3(140, 0, 0), blendType='easeInOut'))),
            (69, Parallel(Func(self.witnessToon2.setChatAbsolute, "I see you're trying to run a trial here with a Cog.", CFSpeech))),
            (73, Func(self.witnessToon2.clearChat)),
            (73, Func(self.witnessToon.angryEyes)),
            (73, Func(self.witnessToon.blinkEyes)),
            (73, Func(self.witnessToon.hideSmileMuzzle)),
            (73, Sequence(Func(base.camera.reparentTo, render), camera.posHprInterval(0, Point3(62, 80, 15.5), Point3(30, 0, 0), blendType='easeInOut'))),
            (73, Sequence(Func(base.camera.reparentTo, render), camera.posHprInterval(1, Point3(63, 79, 15.5), Point3(50, 0, 0), blendType='easeInOut'))),
            (74, Func(self.witnessToon.setChatAbsolute, "I don't really see how that's my problem.", CFSpeech)),
            (78, Func(self.witnessToon.clearChat)),
            (78, Sequence(Func(base.camera.reparentTo, render), camera.posHprInterval(1, Point3(66, 81, 15.5), Point3(50, 0, 0), blendType='easeInOut'))),
            (79, Func(self.witnessToon.setChatAbsolute, "You clearly don't know how a case works...", CFSpeech)),
            (83, Func(self.witnessToon.clearChat)),
            (83, Sequence(Func(base.camera.reparentTo, render), camera.posHprInterval(0, Point3(-2.4, -95, 3), Point3(180, 0, 0), blendType='easeInOut'))),
            (83, Func(self.witnessToon1.setChatAbsolute, "You think??", CFSpeech)),
            (87, Func(self.witnessToon1.clearChat)),
            (87, Sequence(Func(base.camera.reparentTo, render), camera.posHprInterval(0.5, Point3(-1, -97, 2), Point3(150, 15, 0), blendType='easeInOut'))),
            (87.5, Func(self.witnessToon1.setChatAbsolute, "I would love to see-", CFSpeech)),
            (89, Func(self.witnessToon1.clearChat)),
            (89, Parallel(Func(base.camera.reparentTo, render), camera.posHprInterval(0.5, Point3(-2.4, -100.6, 19.5), Point3(0, 0, 0), blendType='easeInOut'), Func(self.setChatAbsolute, "SILENCE!", CFSpeech))),
            (93, Func(self.clearChat)),
            (93, Parallel(Func(base.camera.reparentTo, render), camera.posHprInterval(4, Point3(-2.4, -115, 19.5), Point3(0, 0, 0), blendType='easeInOut'), Func(self.setChatAbsolute, "I don't care who started this mess, you all still count as Toons.", CFSpeech))),
            (97, Func(self.clearChat)),
            (97, Parallel(Func(base.camera.reparentTo, render), camera.posHprInterval(0.5, Point3(-2.4, -98, 6), Point3(0, 30, 0), blendType='easeInOut'), Func(self.setChatAbsolute, "You had ONE job, and that was to have a debate with me!", CFSpeech))),
            (101, Func(self.clearChat)),
            (101, Parallel(Func(base.camera.reparentTo, render), camera.posHprInterval(4, Point3(-2.4, -125, 19.5), Point3(0, 0, 0), blendType='easeInOut'), Func(self.setChatAbsolute, "Since you refuse my offer, I unfortunately must give you a punishment you won't regret...", CFSpeech))),
            (105, Func(self.clearChat)),
            (105, Parallel(Func(base.camera.reparentTo, render), camera.posHprInterval(0.5, Point3(-2.4, -100.6, 19.5), Point3(0, 0, 0), blendType='easeInOut'), Func(self.setChatAbsolute, "A fight to the death of orange!", CFSpeech))),
            (108, Func(self.clearChat)),
            (108, Parallel(LerpColorScaleInterval(render, 0, Vec4(1.0, 0.5, 0, 1.0)), SoundInterval(coloreffectSfx))),
            (110, Func(self.witnessToon1.loop, 'walk')),
            (110, Func(self.witnessToon2.loop, 'walk')),
            (110, Parallel(Func(self.witnessToon1.setChatAbsolute, "Why you little-", CFSpeech), Func(base.camera.reparentTo, render), camera.posHprInterval(1, Point3(-4.5, -85, 3), Point3(180, 0, 0), blendType='easeInOut'), self.witnessToon1.posHprInterval(1, Point3(-3, -90, 0), Point3(0, 0, 0), blendType='noBlend'), self.witnessToon2.posHprInterval(1, Point3(-6, -90, 0), Point3(0, 0, 0), blendType='noBlend'))),
            (111, Func(self.witnessToon1.clearChat)),
            (111, Sequence(Func(base.camera.reparentTo, render), camera.posHprInterval(0, Point3(-2.4, -110, 19.5), Point3(0, 0, 0), blendType='easeInOut'))),
            (111, Parallel(Func(base.camera.reparentTo, render), camera.posHprInterval(0.5, Point3(-2.4, -100, 19.5), Point3(0, 0, 0), blendType='easeInOut'), Func(self.loop, 'Ff2Bb_spin'), Func(self.setChatAbsolute, "COMMANDING TOONS TO BE ELIMINATED!", CFSpeech))),
            (115, Func(self.clearChat)),
            (115, Func(self.witnessToon1.loop, 'neutral')),
            (115, Func(self.witnessToon2.loop, 'neutral')),
            ...
            (125, Parallel(Func(base.camera.reparentTo, render), camera.posHprInterval(0.5, Point3(-2.4, -100.6, 19.5), Point3(0, 0, 0), blendType='easeInOut'), Func(self.setChatAbsolute, "This foolishness isn't what I planned.", CFSpeech))),
