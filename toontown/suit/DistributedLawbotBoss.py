...
class DistributedLawbotBoss(DistributedBossCog.DistributedBossCog, FSM.FSM):
    ...
    def makeIntroductionMovie(self, delayDeletes):
        ...
        bossAnimTrack = Sequence(
            ActorInterval(self, 'Ff_speech', startTime=2, duration=70, loop=1),
            ...
            ActorInterval(self, 'Ff_speech', duration=220, loop=1))
        track.append(bossAnimTrack)
        attackToons = TTLocalizer.BossCogAttackToons
        dialogTrack = Track(
            (0, Func(self.setChatAbsolute, "Hey there, Cogs.", CFSpeech)),
            (4, Func(self.clearChat)),
            (4, Func(self.setChatAbsolute, "Today, we are going to have a debate.", CFSpeech)),
            (7, Func(self.clearChat)),
            (8, Sequence(Func(base.camera.reparentTo, self.witnessToon), Func(base.camera.setPosHpr, 0, 8, 2, 180, 10, 0))),
            (8, Sequence(Func(self.witnessToon.setChatAbsolute, "Hey there, my fellow Toons!", CFSpeech))),
            (12, Func(self.witnessToon.clearChat)),
            (12, Sequence(Func(self.witnessToon.setChatAbsolute, "I'm so happy that we're doing this.", CFSpeech))),
            (16, Func(self.witnessToon.clearChat)),
            (16, Sequence(Func(self.witnessToon.setChatAbsolute, "And today we're going to debate about why zap is good.", CFSpeech))),
            (20, Func(self.witnessToon.clearChat)),
            ...
            (34, Func(self.witnessToon.clearChat)),
            (34, Sequence(Func(self.witnessToon.setChatAbsolute, "So, here's why zap is good.", CFSpeech))),
            (38, Func(self.witnessToon.clearChat)),
            (38, Sequence(Func(self.witnessToon.setChatAbsolute, "You can do some extra combo damage if you use squirt on them.", CFSpeech))),
            (42, Func(self.witnessToon.clearChat)),
            (42, Sequence(Func(self.witnessToon.setChatAbsolute, "Zap is so good that you can do anything to it.", CFSpeech))),
            (46, Func(self.witnessToon.clearChat)),
            (46.5, Sequence(Func(self.loop, 'Ff_speech'), Func(base.camera.reparentTo, render), Func(base.camera.setPosHpr, -2.4, -110.6, 19.5, 0, 0, 0))),
            (46.5, Func(self.setChatAbsolute, "Shut, you get that weak stuff out of here.", CFSpeech)),
            (51, Func(self.clearChat)),
            (51, Func(self.setChatAbsolute, "Zap is bad and you know that, throw is better.", CFSpeech)),
            (55, Func(self.clearChat)),
            (55, Sequence(Func(base.camera.reparentTo, self.witnessToon), Func(base.camera.setPosHpr, 0, 8, 2, 180, 10, 0))),
            (55.5, Sequence(Func(self.witnessToon.setChatAbsolute, "Actually, zap is.", CFSpeech))),
            (60, Func(self.witnessToon.clearChat)),
            (60, Sequence(Func(self.witnessToon.setChatAbsolute, "Throw bad because you can't do good combos.", CFSpeech))),
            (64, Func(self.witnessToon.clearChat)),
            (64, Sequence(Func(self.witnessToon.setChatAbsolute, "And you can't kill all cogs with them.", CFSpeech))),
            (68, Func(self.witnessToon.clearChat)),
            (68, Sequence(Func(self.loop, 'Ff_speech'), Func(base.camera.reparentTo, render), Func(base.camera.setPosHpr, -2.4, -110.6, 19.5, 0, 0, 0))),
            (68.5, Func(self.setChatAbsolute, "Yeah you can.", CFSpeech)),
            (71, Func(self.clearChat)),
            (71, Func(self.setChatAbsolute, "In TTR, you can kill all 4 with wedding cake.", CFSpeech)),
            (75, Func(self.clearChat)),
            (75.5, Sequence(Func(base.camera.reparentTo, self.witnessToon), Func(base.camera.setPosHpr, 0, 8, 2, 180, 10, 0))),
            (75.5, Sequence(Func(self.witnessToon.setChatAbsolute, "TTR? What?", CFSpeech))),
            (80, Func(self.witnessToon.clearChat)),
            (80, Sequence(Func(self.witnessToon.setChatAbsolute, "I mean, it's not bad, just... not the best.", CFSpeech))),
            (84, Func(self.witnessToon.clearChat)),
            (84, Sequence(Func(self.witnessToon.setChatAbsolute, "Clash actually has zap, so it's better.", CFSpeech))),
            (88, Func(self.witnessToon.clearChat)),
            (88.5, Sequence(Func(self.loop, 'Ff_speech'), Func(base.camera.reparentTo, render), Func(base.camera.setPosHpr, -2.4, -110.6, 19.5, 0, 0, 0))),
            (88.5, Func(self.setChatAbsolute, "NO SHUT.", CFSpeech)),
            (91, Func(self.clearChat)),
            (91, Func(self.setChatAbsolute, "I SAY, THROW IS BETTER!", CFSpeech)),
            (95, Func(self.clearChat)),
            (95.5, Sequence(Func(base.camera.reparentTo, self.witnessToon), Func(base.camera.setPosHpr, 0, 8, 2, 180, 10, 0))),
            (95.5, Sequence(Func(self.witnessToon.setChatAbsolute, "I say, ZAP IS BETTER!", CFSpeech))),
            (100, Func(self.witnessToon.clearChat)),
            (100.5, Sequence(Func(self.loop, 'Ff_speech'), Func(base.camera.reparentTo, render), Func(base.camera.setPosHpr, -2.4, -110.6, 19.5, 0, 0, 0))),
            (100.5, Func(self.setChatAbsolute, "THROW!", CFSpeech)),
            (101.2, Func(self.clearChat)),
            (101.5, Sequence(Func(base.camera.reparentTo, self.witnessToon), Func(base.camera.setPosHpr, 0, 8, 2, 180, 10, 0))),
            (101.5, Sequence(Func(self.witnessToon.setChatAbsolute, "ZAP!", CFSpeech))),
            (103, Func(self.witnessToon.clearChat)),
            (103, Sequence(Func(self.loop, 'Ff_speech'), Func(base.camera.reparentTo, render), Func(base.camera.setPosHpr, -2.4, -110.6, 19.5, 0, 0, 0))),
            (103, Func(self.setChatAbsolute, "THROW!", CFSpeech)),
            (103.5, Func(self.clearChat)),
            (103.5, Sequence(Func(base.camera.reparentTo, self.witnessToon), Func(base.camera.setPosHpr, 0, 8, 2, 180, 10, 0))),
            (103.5, Sequence(Func(self.witnessToon.setChatAbsolute, "ZAP!", CFSpeech))),
            (104, Func(self.witnessToon.clearChat)),
            (104, Sequence(Func(self.loop, 'Ff_speech'), Func(base.camera.reparentTo, render), Func(base.camera.setPosHpr, -2.4, -110.6, 19.5, 0, 0, 0))),
            (104, Func(self.setChatAbsolute, "THROW!", CFSpeech)),
            (104.5, Func(self.clearChat)),
            (104.5, Sequence(Func(base.camera.reparentTo, self.witnessToon), Func(base.camera.setPosHpr, 0, 8, 2, 180, 10, 0))),
            (104.5, Sequence(Func(self.witnessToon.setChatAbsolute, "ZAP!", CFSpeech))),
            (105, Func(self.witnessToon.clearChat)),
            (105, Sequence(Func(self.loop, 'Ff_speech'), Func(base.camera.reparentTo, render), Func(base.camera.setPosHpr, -2.4, -110.6, 19.5, 0, 0, 0))),
            (105, Func(self.setChatAbsolute, "THROW!", CFSpeech)),
            (105.5, Func(self.clearChat)),
            (105.5, Sequence(Func(base.camera.reparentTo, self.witnessToon), Func(base.camera.setPosHpr, 0, 8, 2, 180, 10, 0))),
            (105.5, Sequence(Func(self.witnessToon.setChatAbsolute, "THROW!", CFSpeech))),
            (107, Func(self.witnessToon.clearChat)),
            (107, Sequence(Func(self.loop, 'Ff_speech'), Func(base.camera.reparentTo, render), Func(base.camera.setPosHpr, -2.4, -110.6, 19.5, 0, 0, 0))),
            (107, Func(self.setChatAbsolute, "ZAP!", CFSpeech)),
            (109, Func(self.clearChat)),
            (109, Sequence(Func(self.loop, 'Ff_speech'), Func(base.camera.reparentTo, render), Func(base.camera.setPosHpr, -2.4, -110.6, 19.5, 0, 0, 0))),
            (109, Func(self.setChatAbsolute, "I SAY ZAP GOOD AND THAT'S FINAL!!!!!!", CFSpeech)),
            (113, Func(self.clearChat)),
            (113, Sequence(Func(base.camera.reparentTo, self.witnessToon), Func(base.camera.setPosHpr, 0, 8, 2, 180, 10, 0))),
            (113, Sequence(Func(self.witnessToon.setChatAbsolute, "Ok, whatever you say.", CFSpeech))),
            (117, Func(self.witnessToon.clearChat)),
            (117, Sequence(Func(self.loop, 'Ff_speech'), Func(base.camera.reparentTo, render), Func(base.camera.setPosHpr, -2.4, -110.6, 19.5, 0, 0, 0))),
            (120, Func(self.setChatAbsolute, "Hold up, what!?", CFSpeech)),
            (123, Func(self.clearChat)),
            (123, Func(self.setChatAbsolute, "Did I seriously say that???", CFSpeech)),
            (127, Func(self.clearChat)),
            (127, Sequence(Func(base.camera.reparentTo, self.witnessToon), Func(base.camera.setPosHpr, 0, 8, 2, 180, 10, 0))),
            (127.2, Sequence(Func(self.witnessToon.setChatAbsolute, "Yes. Yes you did.", CFSpeech))),
            (131, Func(self.witnessToon.clearChat)),
            (131, Sequence(Func(self.loop, 'Ff_speech'), Func(base.camera.reparentTo, render), Func(base.camera.setPosHpr, -2.4, -110.6, 19.5, 0, 0, 0))),
            (131, Func(self.setChatAbsolute, "Typical...", CFSpeech)),
            (134, Func(self.clearChat)),
            (134, Func(self.setChatAbsolute, "But that is not how you do it.", CFSpeech)),
            (138, Func(self.clearChat)),
            (138, Func(self.setChatAbsolute, "You see, many Cogs would be destroyed if you just use throw.", CFSpeech)),
            (142, Func(self.clearChat)),
            (142, Sequence(Func(base.camera.reparentTo, self.witnessToon), Func(base.camera.setPosHpr, 0, 8, 2, 180, 10, 0))),
            (142, Sequence(Func(self.witnessToon.setChatAbsolute, "Wrong.", CFSpeech))),
            (146, Func(self.witnessToon.clearChat)),
            (146, Sequence(Func(base.camera.reparentTo, self.witnessToon), Func(base.camera.setPosHpr, 0, 8, 2, 180, 10, 0))),
            (146, Sequence(Func(self.witnessToon.setChatAbsolute, "Zap better.", CFSpeech))),
            (149, Func(self.witnessToon.clearChat)),
            (149, Sequence(Func(self.loop, 'Ff_speech'), Func(base.camera.reparentTo, render), Func(base.camera.setPosHpr, -2.4, -110.6, 19.5, 0, 0, 0))),
            (149, Func(self.setChatAbsolute, "No shut, get that garbage out of here.", CFSpeech)),
            (153, Func(self.clearChat)),
            (153, Func(self.setChatAbsolute, "Zap is bad and you know that.", CFSpeech)),
            (156, Func(self.clearChat)),
            (156, Sequence(Func(base.camera.reparentTo, self.witnessToon), Func(base.camera.setPosHpr, 0, 8, 2, 180, 10, 0))),
            (156, Sequence(Func(self.witnessToon.setChatAbsolute, "Order! Order in the court!", CFSpeech))),
            (159, Func(self.witnessToon.clearChat)),
            (159, Sequence(Func(self.witnessToon.setChatAbsolute, "Zap good and that's that!", CFSpeech))),
            (163, Func(self.witnessToon.clearChat)),
            (163, Sequence(Func(self.loop, 'Ff_speech'), Func(base.camera.reparentTo, render), Func(base.camera.setPosHpr, -2.4, -110.6, 19.5, 0, 0, 0))),
            (163, Func(self.setChatAbsolute, "Says you, I'm the one who has to deal with these noobs with zap.", CFSpeech)),
            (167, Func(self.clearChat)),
            (167, Func(self.setChatAbsolute, "WHY DOES NOBODY HAVE THROW HERE?!?!?!?!?!?", CFSpeech)),
            (171, Func(self.clearChat)),
            (171, Sequence(Func(base.camera.reparentTo, self.witnessToon), Func(base.camera.setPosHpr, 0, 8, 2, 180, 10, 0))),
            (171, Sequence(Func(self.witnessToon.setChatAbsolute, "Because.", CFSpeech))),
            (173, Func(self.witnessToon.clearChat)),
            (173, Sequence(Func(self.witnessToon.setChatAbsolute, "Yes.", CFSpeech))),
            (175, Func(self.witnessToon.clearChat)),
            (175, Sequence(Func(self.loop, 'Ff_speech'), Func(base.camera.reparentTo, render), Func(base.camera.setPosHpr, -2.4, -110.6, 19.5, 0, 0, 0))),
            (175, Func(self.setChatAbsolute, "That's it!", CFSpeech)),
            (178, Func(self.clearChat)),
            (178, Func(self.setChatAbsolute, "I had enough of your games!", CFSpeech)),
            (182, Func(self.clearChat)),
            (182, Func(self.setChatAbsolute, "You think you know everything...", CFSpeech)),
            (186, Func(self.clearChat)),
            (186, Func(self.setChatAbsolute, "And you wasted my time!", CFSpeech)),
            (190, Func(self.clearChat)),
            (190, Sequence(Func(base.camera.reparentTo, self.witnessToon), Func(base.camera.setPosHpr, 0, 8, 2, 180, 10, 0))),
            (190, Sequence(Func(self.witnessToon.setChatAbsolute, "It's ok. I have all day.", CFSpeech))),
            (194, Func(self.witnessToon.clearChat)),
            (194, Sequence(Func(self.witnessToon.setChatAbsolute, "Overall, trials are supposed to take an hour.", CFSpeech))),
            (198, Func(self.witnessToon.clearChat)),
            (198, Sequence(Func(self.loop, 'Ff_speech'), Func(base.camera.reparentTo, render), Func(base.camera.setPosHpr, -2.4, -110.6, 19.5, 0, 0, 0))),
            (198, Func(self.setChatAbsolute, "An hour!??!?!?!?!", CFSpeech)),
            (202, Func(self.clearChat)),
            (202, Func(self.setChatAbsolute, "No, not dealing with this.", CFSpeech)),
            (206, Func(self.clearChat)),
            (206, Sequence(Func(base.camera.reparentTo, self.witnessToon), Func(base.camera.setPosHpr, 0, 8, 2, 180, 10, 0))),
            (206, Sequence(Func(self.witnessToon.setChatAbsolute, "Too bad, you have to!", CFSpeech))),
            (210, Func(self.witnessToon.clearChat)),
            (210, Sequence(Func(self.witnessToon.setChatAbsolute, "You have to do it!", CFSpeech))),
            (214, Func(self.witnessToon.clearChat)),
            (214, Sequence(Func(self.loop, 'Ff_speech'), Func(base.camera.reparentTo, render), Func(base.camera.setPosHpr, -2.4, -110.6, 19.5, 0, 0, 0))),
            (214, Func(self.setChatAbsolute, "I don't think so...", CFSpeech)),
            (218, Func(self.clearChat)),
            (218, Func(self.setChatAbsolute, "I'm tired of waiting, and these suits are probably Toons.", CFSpeech)),
            (222, Func(self.clearChat)),
            (222, Sequence(Func(base.camera.reparentTo, self.witnessToon), Func(base.camera.setPosHpr, 0, 8, 2, 180, 10, 0))),
            (222, Sequence(Func(self.witnessToon.setChatAbsolute, "Get back on topic.", CFSpeech))),
            (225, Func(self.witnessToon.clearChat)),
            (225, Sequence(Func(self.witnessToon.setChatAbsolute, "It's about the zap, and why it's good.", CFSpeech))),
            (228, Func(self.witnessToon.clearChat)),
            (228, Sequence(Func(self.loop, 'Ff_speech'), Func(base.camera.reparentTo, render), Func(base.camera.setPosHpr, -2.4, -110.6, 19.5, 0, 0, 0))),
            (228, Func(self.setChatAbsolute, "That, does it!", CFSpeech)),
            (231, Func(self.clearChat)),
            (231, Func(self.setChatAbsolute, "I have waited long enough for this!", CFSpeech)),
            (235, Func(self.clearChat)),
            (235, Func(self.setChatAbsolute, "And you people are doing absolutely nothing about it!", CFSpeech)),
            (240, Func(self.clearChat)),
            (240, Sequence(Func(base.camera.reparentTo, self.witnessToon), Func(base.camera.setPosHpr, 0, 8, 2, 180, 10, 0))),
            (240, Sequence(Func(self.witnessToon.setChatAbsolute, "People? Ooh, I take offense.", CFSpeech))),
            (244, Func(self.witnessToon.clearChat)),
            (244, Sequence(Func(self.witnessToon.setChatAbsolute, "We are Toons, for crying out loud!", CFSpeech))),
            (248, Func(self.witnessToon.clearChat)),
            (248, Sequence(Func(self.loop, 'Ff_speech'), Func(base.camera.reparentTo, render), Func(base.camera.setPosHpr, -2.4, -110.6, 19.5, 0, 0, 0))),
            (248, Func(self.setChatAbsolute, "You ruined the topic, for long enough!", CFSpeech)),
            (252, Func(self.clearChat)),
            (252, Func(self.setChatAbsolute, "The FashionBoss had absolutely no luck in his favor...", CFSpeech)),
            (256, Func(self.clearChat)),
            (256, Func(self.setChatAbsolute, "Elvis did nothing but trouble...", CFSpeech)),
            (260, Func(self.clearChat)),
            (260, Func(self.setChatAbsolute, "I will not fail my trial like this...", CFSpeech)),
            (264, Func(self.clearChat)),
            (264, Sequence(Func(self.loop, 'Ff_speech'), Func(base.camera.reparentTo, render), Func(base.camera.setPosHpr, -2.4, -130.6, 19.5, 0, 0, 0))),
            (264, Func(self.setChatAbsolute, "I did not stand my ground for no reason...", CFSpeech)),
            (268, Func(self.clearChat)),
            (268, Sequence(Func(self.loop, 'Ff_speech'), Func(base.camera.reparentTo, render), Func(base.camera.setPosHpr, -2.4, -110.6, 19.5, 0, 0, 0))),
            (268, Func(self.setChatAbsolute, "My Laser Cogs are more powerful than you could ever imagine.", CFSpeech)),
            (272, Func(self.clearChat)),
            (272, Sequence(Func(base.camera.reparentTo, self.witnessToon), Func(base.camera.setPosHpr, 0, 8, 2, 180, 10, 0))),
            (272, Sequence(Func(self.witnessToon.setChatAbsolute, "Ooh! I'm so so so scared!", CFSpeech))),
            (276, Func(self.witnessToon.clearChat)),
            (276, Sequence(Func(self.witnessToon.setChatAbsolute, "You can't win everything, sir.", CFSpeech))),
            (280, Func(self.witnessToon.clearChat)),
            (280, Sequence(Func(self.witnessToon.setChatAbsolute, "Alright, I'm done.", CFSpeech))),
            (284, Func(self.witnessToon.clearChat)),
            (284, Sequence(Func(self.loop, 'Ff_speech'), Func(base.camera.reparentTo, render), Func(base.camera.setPosHpr, -2.4, -110.6, 19.5, 0, 0, 0))),
            (284, Func(self.setChatAbsolute, "It's about time...", CFSpeech)),
            (288, Func(self.clearChat)),
            (288, Func(self.setChatAbsolute, "I knew I could have ended that discussion a long time ago...", CFSpeech)),
            (292, Func(self.clearChat)),
			(292, Sequence(Func(self.loop, 'Ff_speech'), Func(base.camera.reparentTo, render), Func(base.camera.setPosHpr, -2.4, -130.6, 19.5, 0, 0, 0))),
            (292, Func(self.setChatAbsolute, "Now it's time that you seal your fate!", CFSpeech)), 
            (296, Sequence(
                Func(self.clearChat),
    ...
    def makeVictoryMovie(self):
        ...
        bossTrack = Track(
            ...
            LerpColorScaleInterval(render, 2, Vec4(1.0, 0.0, 0.5, 0.0))))
