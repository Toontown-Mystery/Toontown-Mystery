...
class DistributedLawbotBoss(DistributedBossCog.DistributedBossCog, FSM.FSM):
    ...
    def makeIntroductionMovie(self, delayDeletes):
        ...
        dialogTrack = Track(
            ...
            (4, Func(self.setChatAbsolute, TTLocalizer.LawbotBossTempIntro1, CFSpeech)),
            (8, Func(self.clearChat)),
            (8, Sequence(Func(base.camera.reparentTo, self.witnessToon), Func(base.camera.setPosHpr, 0, 8, 2, 180, 10, 0))),
            (8, Sequence(Func(self.witnessToon.setChatAbsolute, TTLocalizer.LawbotWitnessToon1, CFSpeech))),
            (12, Func(self.witnessToon.clearChat)),
            (12, Sequence(Func(self.witnessToon.setChatAbsolute, TTLocalizer.LawbotWitnessToon2, CFSpeech))),
            (16, Func(self.witnessToon.clearChat)),
            (16, Sequence(Func(self.witnessToon.setChatAbsolute, TTLocalizer.LawbotWitnessToon3, CFSpeech))),
            (20, Func(self.witnessToon.clearChat)),
            (20, Sequence(Func(self.loop, 'Ff_speech'), Func(base.camera.reparentTo, render), Func(base.camera.setPosHpr, -2.4, -100.6, 19.5, 0, 0, 0))),
            (24, Func(self.setChatAbsolute, TTLocalizer.LawbotBossTempShut1, CFSpeech)),
            (26, Func(self.clearChat)),
            (26, Func(self.setChatAbsolute, TTLocalizer.LawbotBossTempShut2, CFSpeech)),
            (30, Func(self.clearChat)),
            (30, Sequence(Func(base.camera.reparentTo, self.witnessToon), Func(base.camera.setPosHpr, 0, 8, 2, 180, 10, 0))),
            (30, Sequence(Func(self.witnessToon.setChatAbsolute, TTLocalizer.LawbotWitnessToon4, CFSpeech))),
            (34, Func(self.witnessToon.clearChat)),
            (34, Sequence(Func(self.witnessToon.setChatAbsolute, TTLocalizer.LawbotWitnessToon5, CFSpeech))),
            (38, Func(self.witnessToon.clearChat)),
            (38, Sequence(Func(self.loop, 'Ff_speech'), Func(base.camera.reparentTo, render), Func(base.camera.setPosHpr, -2.4, -100.6, 19.5, 0, 0, 0))),
            (38, Func(self.setChatAbsolute, TTLocalizer.LawbotBossTempIntro2, CFSpeech)),
			(41, Func(self.clearChat)),
			(41, Sequence(Func(self.loop, 'Ff_speech'), Func(base.camera.reparentTo, render), Func(base.camera.setPosHpr, -2.4, -110.6, 19.5, 0, 0, 0))),
            (41, Func(self.setChatAbsolute, TTLocalizer.LawbotBossTempIntro3, CFSpeech)), 
            (45, Sequence(
                Func(self.clearChat),
