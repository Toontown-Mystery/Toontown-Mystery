...
class DistributedLawbotBoss(DistributedBossCog.DistributedBossCog, FSM.FSM):
    ...
    def makeIntroductionMovie(self, delayDeletes):
        ...
        dialogTrack = Track(
            ...
            (75.5, Sequence(Func(self.witnessToon.setChatAbsolute, "TTR? Bruh that noobish game.", CFSpeech))),
            (80, Func(self.witnessToon.clearChat)),
            (80, Sequence(Func(self.witnessToon.setChatAbsolute, "If you play TTR then ur bad.", CFSpeech))),
