...
class DistributedSellbotBoss(DistributedBossCog.DistributedBossCog, FSM.FSM):
    ...
    def makeIntroductionMovie(self, delayDeletes):
        ...
        dialogTrack = Track(
            ...
            (27, camera.posHprInterval(4, (-25, -35, 20), (-90, 10, 0), blendType='easeInOut')),
            ...
            (57, Sequence(
                ...
                Parallel(self.backupToonsToBattlePosition(self.toonsA, self.battleANode),
                         ...
                         Sequence(
                             Wait(3),
                             camera.posHprInterval(1, (-25, -35, 16), (-90, 10, 0), blendType='easeInOut'),
                             ...
                             camera.posHprInterval(1.5, (-25, -35, 18.5), (-90, 10, 0), blendType='easeInOut'),
                             Wait(2))))))
