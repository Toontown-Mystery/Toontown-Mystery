...
class DistributedBossbotBoss(DistributedBossCog.DistributedBossCog, FSM.FSM):
    ...
    def __makeResistanceToon(self):
        if self.resistanceToon:
            return
        npc = NPCToons.createLocalNPC(777)
        npc.setName('Queen Lillie')
        npc.setPickable(0)
    ...
    def makeIntroductionMovie(self, delayDeletes):
        ...
        track = Sequence(Func(camera.reparentTo, render), Func(camera.setPosHpr, *elevCamPosHpr), Func(rToon.setChatAbsolute, TTL.BossbotRTWelcome, CFSpeech), Wait(4), Func(rToon.clearChat), LerpPosHprInterval(camera, 3, closeUpRTCamPos, closeUpRTCamHpr), Func(rToon.setChatAbsolute, TTL.BossbotRTRemoveSuit1, CFSpeech), Wait(2.5), Func(rToon.clearChat), Func(rToon.setChatAbsolute, TTL.BossbotRTRemoveSuit2, CFSpeech), Wait(2.5), Func(rToon.clearChat), Func(rToon.setChatAbsolute, TTL.BossbotRTRemoveSuit3, CFSpeech), Wait(2.5), Func(rToon.clearChat), Func(rToon.setChatAbsolute, TTL.BossbotRTRemoveSuit4, CFSpeech), Wait(2.5), Func(rToon.clearChat), self.loseCogSuits(self.toonsA + self.toonsB, render, (loseSuitCamPos[0],
         loseSuitCamPos[1],
         loseSuitCamPos[2],
         loseSuitCamHpr[0],
         loseSuitCamHpr[1],
    ...
    def makePrepareBattleTwoMovie(self, delayDeletes):
        ...
        track = Sequence(
            ...
            Parallel(LerpHprInterval(self.banquetDoor, 3, Point3(90, 0, 0)),
            ...
            Wait(4),
            Parallel(
                LerpHprInterval(self.banquetDoor, 3, Point3(0, 0, 0)),
                LerpPosHprInterval(camera, 3, getCamRTPos, Point3(10, -8, 0))),
            ...
            Wait(4),
            LerpHprInterval(self.banquetDoor, 3, Point3(120, 0, 0)),
            Sequence(
    ...
    def makePrepareBattleFourMovie(self):
        ...
        track = Sequence(
            ...
            Func(self.__hideResistanceToon),
            Func(camera.reparentTo, self),
            Func(camera.setPos, Point3(0, -45, 7)),
            ...
            LerpPosHprInterval(camera, duration=0.5, pos=Point3(8, -50, 17), hpr=(20, 0, 0), blendType='easeInOut'),
    ...
    def makeVictoryMovie(self):
        ...
        bossTrack = Sequence(
            ...
            Func(camera.setPos, Point3(0, -45, 7)),
            Func(camera.setHpr, Point3(0, 14, 0)),
            Func(self.setChatAbsolute, 'Ha, you think you could beat me?', CFSpeech),
            Wait(3),
            Func(self.clearChat),
            LerpPosHprInterval(camera, duration=0.5, pos=Point3(0, -33, 17), hpr=(0, 10, 0), blendType='easeInOut'),
            Func(self.setChatAbsolute, 'Think again, I will not give up.', CFSpeech),
            Wait(3),
            Func(self.clearChat),
            LerpPosHprInterval(camera, duration=1, pos=Point3(0, -37, 17), hpr=(0, 10, -10), blendType='easeInOut'),
            Func(self.setChatAbsolute, 'The only way for me to give up is that if I turn to a level 1 Cog.', CFSpeech),
            Wait(5),
            Func(self.clearChat),
            Func(self.__showResistanceToon, True),
            Func(rToon.setPos, Point3(0, -15, 0)),
            Func(rToon.setHpr, Point3(0, 0, 0)),
            Func(camera.reparentTo, rToon),
            Func(camera.setPos, Point3(0, 7, 4 + offsetZ)),
            Func(camera.setHpr, Point3(-180, 0, 0)),
            Func(rToon.setChatAbsolute, "Oh, and I know just how to do that!", CFSpeech),
            Wait(4.0),
            Func(rToon.clearChat),
            Func(rToon.setChatAbsolute, "-presses button-", CFSpeech),
            Wait(1.5),
            Func(rToon.clearChat),
            Func(camera.reparentTo, self),
            Func(camera.setPos, Point3(0, -37, 17)),
            Func(camera.setHpr, Point3(0, 10, 0)),
            Func(self.setChatAbsolute, TTL.BossbotRewardSpeech1, CFSpeech),
            Wait(3),
			Func(self.clearChat),
            LerpPosHprInterval(camera, duration=2, pos=Point3(0, -65, 5), hpr=(0, 10, 0), blendType='easeInOut'),
