...
class DistributedBossCog(DistributedAvatar.DistributedAvatar, BossCog.BossCog):
    ...
    def announceGenerate(self):
        ...
        bubbleL = CollisionSphere(10, -5, 0, 7)
        ...
        self.bubbleR.stash()
        bubbleB = CollisionSphere(0, 25, 0, 10)
        ...
        self.bubbleB.stash()
        bubbleF = CollisionSphere(0, -25, 0, 7)
        ...
        self.bubbleF.stash()
        bubbleFL = CollisionSphere(-10, 0, 0, 7)
        ...
        self.bubbleFL.stash()
        bubbleFR = CollisionSphere(25, 0, 0, 7)
