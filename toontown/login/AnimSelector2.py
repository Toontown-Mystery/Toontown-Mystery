...
class AnimSelector2():
    ...
    def create(self):
        ...
        self.AnimButton = DirectButton(image=(self.YB, self.Hover), relief=None, text="Karen's Property", text_font=ToontownGlobals.getToonFont(), text_fg=(0.1, 0.1, 0.1, 1), text_pos=TTLocalizer.AnimationsButtonPos, text_scale=0.05, image_scale=1, image1_scale=0.9, image2_scale=0.9, scale=0.9, pos=(0, 0, 0.5), command=self.loadAnimationOne)
