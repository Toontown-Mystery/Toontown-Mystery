...
class TownLoader(StateData.StateData):
    ...
    def load(self, zoneId):
        ...
        self.battleMusic = base.loadMusic(self.zone2music.get(ZoneUtil.getHoodId(zoneId), 'phase_3.5/audio/bgm/encntr_general_bg.ogg'))#'phase_3.5/audio/bgm/encntr_general_bg.ogg'))
